...
[배포처 바로가기](https://m.blog.naver.com/PostView.nhn?blogId=hp0&logNo=221206126048&proxyReferer=https:%2F%2Fwww.google.co.kr%2F)

&nbsp;

## 웹 폰트

사용하는 `font-family`의 이름은 `HSDookubi`입니다.
...
@font-face {
    ...
    src: url('https://cdn.jsdelivr.net/gh/fonts-archive/HSDookubi/HSDookubi.woff2') format('woff2'),
         ...
         url('https://cdn.jsdelivr.net/gh/fonts-archive/HSDookubi/HSDookubi.otf') format('opentype'),
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/HSDookubi/subsets/HSDookubi-dynamic-subset.css" type="text/css"/>
```

### CSS

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/HSDookubi/subsets/HSDookubi-dynamic-subset.css');
```
...
```css
font-family: "HSDookubi", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
